...
public class CustomerOrderSetupActivity extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        btnContinue.setOnClickListener(v -> {
            ...
            // ĐÃ SỬA: Chuyển sang CustomerMainActivity thay vì CustomerMenuFragment (Fragment)
            Intent intent = new Intent(CustomerOrderSetupActivity.this, CustomerMainActivity.class);
            ...
            // Thêm cờ để làm sạch stack nếu cần, tùy thuộc vào flow ứng dụng
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish(); // Đóng màn hình setup sau khi đã chọn xong
        });
    }
